            ...
            <div class="developments-list">
                ...
                <div class="developments-list__bg-bottom">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
                        <path class="developments-list__shape-fill" opacity="0.33"
                        ...
                        <path class="developments-list__shape-fill" opacity="0.66"
                        ...
                        <path class="developments-list__shape-fill"
                ...
                <div class="container">
                    <div class="developments-content__columns">
                        <div class="developments-content__column developments-content__column--left">
                            ...
                            <p>И, естественно, у нас скопились кое-какие скрипты, плагины для вордпресса, шаблоны и
                                много прочей вкуснятины. А написанный <strong>функционал должен использоваться</strong>.
                                Для того чтобы все это не простаивало без дела - мы решили поделиться ими с
                                общественностью. Все решения <strong>доступны для свободного использования</strong>.</p>
                            <br>
                            <a href="#" class="btn btn--primary"><i class="far fa-credit-card"></i>Заказать
                                индивидуальное решение</a>
                        </div>
                        <div class="developments-content__column developments-content__column--right">
                            <img src="<?php echo \Yii::$app->request->BaseUrl; ?>/images/woman-design.png"
                                 class="img-fluid"/>
                        </div>
                    </div>
                </div>
