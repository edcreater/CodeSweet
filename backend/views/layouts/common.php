                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => Yii::t('backend', 'Portfolio'), 'url' => ['/work/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'work')],
                            ['label' => Yii::t('backend', 'Portfolio Categories'), 'url' => ['/work-category/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'work-category')],
                            ['label' => Yii::t('backend', 'Developments'), 'url' => ['/development/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'development')],
                            ['label' => Yii::t('backend', 'Development Categories'), 'url' => ['/development-category/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'development-category')],
